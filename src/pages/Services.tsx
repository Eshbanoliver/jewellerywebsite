  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="pt-32 pb-16 bg-zinc-950/45 backdrop-blur-md relative overflow-hidden">
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1589674781759-c21c37956a44?q=80&w=1000&auto=format&fit=crop')] bg-cover bg-center opacity-10" />
